The objective is to develop an Employee Management System in Python that utilizes a MySQL Database to store data. The writing will include these actions:
